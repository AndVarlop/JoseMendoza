  ...
  template: `
    <section id="hero" class="hero" role="region" aria-label="Hero">
      ...
      <div class="hero-content">
        <span class="hero-badge">{{ 'hero.badge' | translate }}</span>
        <h1 class="hero-title">
          {{ 'hero.title' | translate }}
          <span class="highlight">{{ 'hero.titleHighlight' | translate }}</span>
        </h1>
        ...
        <div class="hero-actions">
          ...
          >
            ...
            {{ 'hero.whatsapp' | translate }}
          </a>
          <a href="#servicios" class="btn-secondary">
            {{ 'hero.viewServices' | translate }}
          </a>
        </div>
      </div>
      ...
      <div class="scroll-indicator" aria-hidden="true">
        ...
        <span>{{ 'hero.scroll' | translate }}</span>
      </div>
    </section>
  `,
  styles: [`
